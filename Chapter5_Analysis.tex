...
\end{figure}
		...
		Using the geometric sum of the angular separations normalized by the pointing resolution of each event as a function of SNR, we get Equation \ref{eqn:LogLikelihood}.
