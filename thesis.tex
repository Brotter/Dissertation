...
%% making figures that get wrapped in text
\usepackage{wrapfig}
...
%% Linking to sections and chapters
\usepackage{hyperref}


%% To time stamp it on all the pages
\usepackage{fancyhdr}
\setlength{\headheight}{14pt} %fixes a warning message
...
%\keywords{theses, dissertations, graduating, procrastination}
